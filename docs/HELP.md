...
This guide applies to **ParentVUE integration 0.2.3**.
...
Version 0.2.3 currently exposes:
...
Version 0.2.3 bundles a custom card named:
...
After updating from a version before 0.2.3:
