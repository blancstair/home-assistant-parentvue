...
This guide applies to **ParentVUE integration 0.2.4**.
...
Version 0.2.4 currently exposes:
...
Version 0.2.4 bundles a custom card named:
...
After updating from a version before 0.2.4:
